...
- Los puntos se acumulan por negocio — no son transferibles entre negocios distintos, salvo la
  función explícita de "regalar puntos" a otro socio dentro del mismo negocio.
...
No está permitido: crear cuentas falsas para inflar puntos o recompensas, intentar acceder a
datos de otros negocios o clientes sin autorización, ni usar el Servicio para fines ilegales.
...
El Servicio se ofrece "tal cual". Podemos tener interrupciones por mantenimiento; avisaremos
cuando sea posible.
...
Podemos actualizar estos términos. El uso continuado del Servicio después de un cambio implica
aceptación.

## 10. Ley aplicable

Estos términos se rigen por las leyes de la República Argentina para negocios operando en
Argentina, y por las leyes de la República del Paraguay para negocios operando en Paraguay.

---

> **Nota para Tobias — esto es un punto de partida, no asesoramiento legal.** Antes de
> publicar esto con usuarios y negocios reales, hacelo revisar por un abogado/a — en particular
> la sección 6 (para negocios) debería reflejar exactamente las condiciones comerciales reales
> que definas (setup+mensual vs. marketplace con comisión, según lo que decidan más adelante).
