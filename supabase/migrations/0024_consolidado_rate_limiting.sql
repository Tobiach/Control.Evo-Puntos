...
--
-- Reemplaza y absorbe por completo un archivo `0022_referidos_una_visita.sql` que existió en
-- la rama design/explorar-mis-premios-xp con el mismo número que 0022_fix_confirmar_canje_pin.sql
-- de main (contenido distinto) — se eliminó al mergear para no dejar dos archivos "0022"
-- reclamando el mismo número; su único cambio real (v_necesarias 4 -> 1 en
-- revisar_premio_referido) ya está incluido acá abajo.
